    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        <button
          ...
          onClick={() => router.push("/games/translations")}
        >
          Back to States
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 space-y-6">
      ...
      <div className="flex flex-col space-y-4 items-center">
        <button onClick={()=>router.push(`/games/translations/${id}/questions`)} className="px-6 py-3 bg-yellow-400 text-[#4d1414] rounded-lg shadow-md hover:bg-yellow-500">
          Start Test
        </button>
        <button
